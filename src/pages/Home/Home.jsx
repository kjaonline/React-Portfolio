	...
	render(){
		return(
			<div className="page-home">
				<Hero className="home" text="Kris Alcordo" description="I am a Jacksonville based front web developer with an eye for design and a passion for functional interfaces and usability." />
